...
#define LED_FLASH_PRIORITY	( tskIDLE_PRIORITY + 1 ) // original #define LED_FLASH_PRIORITY  ( tskIDLE_PRIORITY + 2 )
#define INTERF_PRIORITY	    ( tskIDLE_PRIORITY + 2 ) // original #define INTERF_PRIORITY	    ( tskIDLE_PRIORITY + 1 )
